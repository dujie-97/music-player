(function($, player) {
    function MusicPlayer(dom) {
        ...
        this.list = null; //列表切歌对象（在listPlay赋值）
    ...
    MusicPlayer.prototype = {
        ...
        getData: function(url) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    This.listPlay(); //列表切歌，要放在loadMusic前面，因为this.list对象是在这个方法里声明的，要在LoadMusic里使用
        ...
        loadMusic: function(index) {
            ...
            this.progress.renderAllTime(this.dataList[index].duration); //加载歌曲的总时长
            ...
            if (player.music.status == 'play') {
                ...
                this.progress.move(0); //切歌的时候要让进度条跟着走
            }
        ...
        musicControl: function() {
            ...
            this.controlBtns[2].addEventListener('touchend', function() {
                if (player.music.status == 'play') {
                    ...
                    //第二次播放的时候需要加上上一次旋转的角度，但是第一次这个角度是没有的，取不到，所以做了一个容错处理
        ...
        dragProgress: function() {
            ...
            circle.move = function(per) {
                This.progress.update(per); //更新进度条
            }
